		...
		const whys = [
			...
			},
			{
				...
				a: [
					...
					<p>House Sister #3 takes residence soon! Emma has spent quality time in the home, cultivating and growing relationships with Becka and McKenzie, sharing fun experiences and community outings together.</p>,
